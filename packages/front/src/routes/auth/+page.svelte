      ...
      <div class="mt-10">
        ...
        <div class="mt-10">
          ...
          <div class="mt-6 grid grid-cols-2 gap-4">
            <a
              href="#"
              class="shadow-xs flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
            >
