...
Also new: `infiniteScroll` (svelte attachment, pairs with `paginate`), `stackHttpClient`/`withHeader` (core), `splitTrim` (formats), and exported `QueryOptionsHelper`/`AggregateOptions`/`FF_Repo*` types.
