...
<script lang="ts">
	...
	import type { DialogShellArgs, DialogConfirmArgs } from 'firstly/svelte'
</script>
...
{#snippet confirm({ message, title, confirmLabel, cancelLabel, danger, confirm, cancel }: DialogConfirmArgs)}
	<div class="modal modal-open">
		<div class="modal-box">
